...
class GraphConfig:
    def __init__(self):
        ...
        # Number of nodes of the graphs we are interested in for the conjecture
        self.num_nodes = 19  
        self.conjecture = 'conj_2_1'
        ...
        self.gumbeldore_config = {
            ...
            "num_instances_to_generate": 100,  # Number of instances to generate in each epoch.
